...
public class tc4_4_1 {
																					// Test Case 4.4.1 - 'when hovering over the widget a shadow appears within the box indicating it as a selector ( Document library widget) 
    ...
    public void testWidgetHoverEffectChrome() {
        ...
        WebElement widget = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("DOCUMENT_LIBRARY_LINK_WIDGET")));
        ...
        for (String clientCode : clientCodes) {
            ...
            widget = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("DOCUMENT_LIBRARY_LINK_WIDGET")));
            actions.moveToElement(widget).perform();
