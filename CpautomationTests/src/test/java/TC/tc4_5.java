...
public class tc4_5 {
																																// Test Case 4.5 - 'when hovering over the widget a shadow appears within the box indicating it as a selector. (Help Center Widget )
    ...
    public void testWidgetHoverEffectChrome() {
        ...
        WebElement widget = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("HELP_CENTER_LINK_WIDGET")));
        ...
        for (String clientCode : clientCodes) {
            ...
            widget = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("HELP_CENTER_LINK_WIDGET")));
            actions.moveToElement(widget).perform();
