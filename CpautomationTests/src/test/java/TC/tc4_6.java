...
public class tc4_6 {
																									// Test Case 4.6 - when hovering over the widget a shadow appears within the box indicating it as a selector. (User Admin Widget) 
    ...
    public void testWidgetHoverEffectChrome() {
        ...
        WebElement widget = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("USER_ADMIN_LINK_WIDGET")));
        ...
        for (String clientCode : clientCodes) {
            ...
            widget = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("USER_ADMIN_LINK_WIDGET")));
            actions.moveToElement(widget).perform();
