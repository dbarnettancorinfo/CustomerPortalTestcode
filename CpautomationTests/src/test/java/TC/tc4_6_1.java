...
public class tc4_6_1 {
																							// Test Case 4.6.1 - 'Clicking on this widget will redirect the user to the Report Viewer page. 
	    ...
	    public void testDocumentLibraryLinkChrome() {
	        ...
	        for (String url : urls) {
	            ...
	            WebElement documentLibraryLink = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("REPORTS_LINK_WIDGET")));
	            documentLibraryLink.click();

	            // Verify the redirected URL
	            String expectedURL = "http://customerportal.development.local/ProductionReports/HTMLReportViewer";
