...
public class tc4_7_1 {
																			// Test Case 4.7.1 - 'Clicking on this widget will redirect the user to the Reference Documents page.(help Center)
	public class tc4_5_1 {
	    ...
	    public void testDocumentLibraryLinkChrome() {
	        ...
	        for (String url : urls) {
	            ...
	            WebElement documentLibraryLink = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("HELP_CENTER_LINK_WIDGET")));
	            documentLibraryLink.click();

	            // Verify the redirected URL
	            String expectedURL = "http://customerportal.development.local/HelpCenter/Reference";
	    ...
	    public void testDocumentLibraryLinkEdge() {
	        ...
	        for (String url : urls) {
	            ...
	            if (actualURL.equals(expectedURL)) {
	               ...
	               System.out.println("Redirected to the wrong URL. Expected: " + expectedURL + ", Actual: " + actualURL);
	            // Assert/assure that the actual URL equals the expected URL
	               Assert.assertEquals(actualURL, expectedURL, "Help Center link did not redirect to the expected URL.");
	            }
	        }
	    }
