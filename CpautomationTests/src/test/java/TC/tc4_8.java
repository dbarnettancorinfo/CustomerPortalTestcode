...
public void testProductsElementChromne() {
 ...
 // Open Ancor Customer Portal Login
    ...
    WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"SiteMenu\"]/div[4]")));
    ...
    WebElement dropdownMenu = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"SiteMenu\"]/div[4]/div[2]/div[2]/div/div")));
    ...
    if (dropdownMenu.isDisplayed()) {
	  ...
	  public void testProductsElementEdge() {
	     ...
	     // Open Ancor Customer Portal Login
	        ...
	        // Wait for the element to appear
	        WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"SiteMenu\"]/div[4]/div[1]")));
