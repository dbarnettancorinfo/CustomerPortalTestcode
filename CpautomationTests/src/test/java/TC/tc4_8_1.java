...
public class tc4_8_1 {
																									// Test Case 4.8.1 - 'Clicking on this widget will redirect the user to the User Review page. (Admin Widget)
	public class tc4_5_1 {
	    ...
	    public void testDocumentLibraryLinkChrome() {
	        ...
	        for (String url : urls) {
	            ...
	            WebElement documentLibraryLink = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("USER_ADMIN_LINK_WIDGET")));
	            documentLibraryLink.click();

	            // Verify the redirected URL
	            String expectedURL = "http://customerportal.development.local/useradministration";
