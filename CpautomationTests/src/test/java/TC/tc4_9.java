...
public class tc4_9 {
																	// Test Case 4.9 - 'when hovering over the element, a drop-down menu of all the possible customer selections should also appear.
	public class tc4_8 {
		// Test Case 4.8 - 'when hovering over the element a line should appear under the element and the element should be highlighted with gray, a drop-down menu of all the possible admin selections should also appear.
...
WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"SiteMenu\"]/div[5]")));
...
WebElement dropdownMenu = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"SiteMenu\"]/div[5]/div[2]/div[2]/div/div")));
...
// Wait for the element to appear
WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[1]/div[4]/div/div[2]/div/div[5]")));
...
// Wait for the dropdown menu to appear
WebElement dropdownMenu = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[1]/div[4]/div/div[2]/div/div[5]/div[2]/div[2]/div/div")));
